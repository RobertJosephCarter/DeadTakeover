...
app.innerHTML = `
  ...
  <div id="menu-overlay">
    <div class="menu-card">
      <h1 id="menu-title">Zombie Squad</h1>
      <p id="menu-subtitle">Survive the open world with your team.</p>
      ...
      <p class="menu-help">WASD Move · Shift Sprint · C Crouch · Space Jump · Click/LMB Shoot · RMB Aim Down Sights · R Reload · 1/2/3 Weapon Slots (Rifle/Shotgun/Pistol) · Q/E Swap Weapon · G Grenade · V Noise Maker · F Melee Knife · B Build Barricade · N Switch Build Type · T Team Swap · P Pause · M Audio. Scavenge materials from zombies! Build wood/metal barricades! Watch for ★ Supply Drops! Special Zombies: Spitter (acid), Hunter (pounces), Charger (charges), Crawler (low)! Corpses revive if not headshot!</p>
